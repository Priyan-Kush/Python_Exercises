...
crsr.execute(sql_command)
sql_command="""CREATE TABLE IF NOT EXISTS job_history(
...
crsr.execute(sql_command)
sql_command="""INSERT OR IGNORE INTO job_history VALUES('122','1995-15-09','1996-15-09','job00002','102');"""
crsr.execute(sql_command)
...
crsr.execute(sql_command)
crsr.execute("SELECT * FROM job_history where job_id='job00002'")
ans = crsr.fetchall()
for i in ans:
    print(i)
connection.close()